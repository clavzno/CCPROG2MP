...
void menu_vaxregistration(struct user *Profiles)
{
...
subfunctions. */
void vaxreg_useregistration(struct user *Profiles)
{
	printf("You are in User Registration.\n");
}
void vaxreg_vaxappointment(struct user *Profiles)
{
	printf("You are in Vaccination Appointment.\n");
}
void vaxreg_faqs(struct user *Profiles)
{
	printf("You are in FAQs.\n");
}
void vaxreg_exit(struct user *Profiles)
{
	system("cls");
	return 0;
}
...
void menu_datamanagement(struct user *Profiles)
{
...
int menu_main(struct user *Profiles)
{
	int choice;
	printf("**************************\n");
	printf("\n");
